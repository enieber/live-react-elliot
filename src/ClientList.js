    ...
    render() {
        ...
        return (
            <div>
                ...
                <a href={`whatsapp://send?abid=${whatsapp}&text=Bem_Vindo!`}>Contato por Whats</a>
                <br/>
                ...
                {this.state.clientes.map(item => (
                    <ClientItem
                        ...
                        onPress={() => {                            
                            ...
                            const listaClientesAntiga = this.state.clientes
                                .filter(cliente => cliente.name != item.name);
